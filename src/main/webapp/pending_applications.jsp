<%--
    ...
    Created on : 31-May-2022, 12:49:54 PM
    Author     : Aayushi
--%>
...
//    get the company name
    String companyName = company.getcName();
...
//    get the result
    if (companyType.equals("regUser")) {
        rs = pdao.getAllPendingApplicationsByName(companyName);
    } else {
        response.sendRedirect("login_page.jsp");
    ...
    <body>
        ...
        <div class="applications">
            <div class="container text-center">
                <h1 style="color:  teal">Pending Applications</h1>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: grey"><b><%= rs.getString("appStatus")%></b></td>
